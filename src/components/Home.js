...
const home = () => {
  ...
  return (
      <>
      <div className="head">
        <h1><a href="https://github.com/purshottamxkumar/link-tree-front" rel="noopener noreferrer" target="_blank">Linktree</a></h1>
      </div>
      <div className="main">
          ...
          <div className="middle-content">
            <div className="middle-content-without-tickets">
              <div className="middle-without-tickets-left">
                ...
                <p id="about-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet laborum cupiditate optio dolorem architecto hic illo cum, soluta molestiae vero tenetur? Minus reiciendis, assumenda officiis exercitationem explicabo nihil! Id, sit.</p>
              </div>
            ...
            <div className="middle-content-with-tickets">
              <div className="tickets">
                <Ticket text = "a new ticket" href="https://www.facebook.com/thepurshottamkumar" src ="/images/monkey.png" alt="monkey-img" />
              </div>
              <div className="tickets">
                <Ticket text = "Lorem ipsum dolor sit amet." src ="/images/monkey.png"/>
              </div>
              <div className="tickets">
